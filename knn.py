# -*- coding: utf-8 -*-
"""
Created on Fri Aug 13 16:34:53 2021

Run and test KNN models 
...
data_dir="D:\\University\\FIT4009 Advance Topics in Intelligent Systems\\Sunglass_Dataset_224x224\\all" 
...
# Model Construction (Minkowski is essentially eucledian when p is 2(which it is by default)) Check Link: https://scikit-learn.org/stable/modules/generated/sklearn.neighbors.DistanceMetric.html#sklearn.neighbors.DistanceMetric
param_grid={'n_neighbors':[5,10,15,20,30], 'metric': ('minkowski', 'chebyshev')}

knn = KNeighborsClassifier()
model=GridSearchCV(knn, param_grid, verbose=4, cv=5)
...
# Loading the model
# joblib.dump(model, 'knn_saved_model.joblib') 
model = joblib.load('D:\\joblibs\\knn_saved_model.joblib') 
