# -*- coding: utf-8 -*-
"""
Created on Sat Aug 14 13:40:08 2021

Run and test Neural Network models 
...
# Model Construction 
param_grid={'alpha':(0.0001, 0.01, 1), 'max_iter': (50, 100, 200, 300),'hidden_layer_sizes': (50, 100, 200, 300)}

neural_network = MLPClassifier()
model=GridSearchCV(neural_network, param_grid, verbose=4, cv=3)
...
# Loading the model
joblib.dump(model, 'neural_network_saved_model.joblib') 
